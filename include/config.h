...
// #define TESTNETWORKEVENTS
#undef TESTSCANANALOG 

// enable/disable digital GPIO for "digital keys"
//#define SCANDIGITAL 

/* enable/disable digital key scan, rotary encoder is not impacted */
#define SCANANALOG
/* print value from analog keybord to serial => define TESTANALOGSCAN */

// enable external Philips Fidelio DS1150 display
#define FIDELO 
